    	...
    	<div class="content col-xs-8">
        	...
        	<article>
                ...
                <div class="post-text">
                    ...
                    <!-- <h2><a href="{{ asset("") }}posts/{{$post->id}}">{{$post->title}}</a></h2> -->
                    <h2><a href="{{ asset("") }}posts/{{$post->slug}}">{{$post->title}}</a></h2> 
                    <p class="text">{{$post->description}}
                        <a href="{{ asset("") }}posts/{{$post->slug}}"><i class="icon-arrow-right2"></i></a>
                    </p>                                 
                </div>
                <div class="post-info">
                	<div class="post-by" style="margin: right">Post By <a href="#">{{$post->user->name}}</a></div>
                    <div class="extra-info">
                    	<a href="#"><i class="icon-facebook5"></i></a>
                		<a href="#"><i class="icon-twitter4"></i></a>
                		<a href="#"><i class="icon-google-plus"></i></a>
                        <span class="comments">28<i class="icon-bubble2"></i></span>
                    </div>
